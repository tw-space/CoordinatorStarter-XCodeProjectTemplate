...
final class SettingsListViewSnapshots: XCTestCase {
  
  // MARK: - Properties
  
  private var rootNavController: UINavigationController!
  private var sut: SettingsListViewController!
  ...
  override func setUpWithError() throws {
    ...
    sut = SettingsListViewController(username: "SignedInUser")
