...
final class ItemsListViewSnapshots: XCTestCase {
  
  // MARK: - Properties
  
  private var waitSeconds: TimeInterval!
  private var rootNavController: UINavigationController!
  private var itemsStore: ItemsStore!
  private var sut: ItemsListViewController!
  ...
  override func setUpWithError() throws {
    ...
    itemsStore = ItemsStore(storeName: "snapshots")
    sut = ItemsListViewController(itemsStore: itemsStore)
