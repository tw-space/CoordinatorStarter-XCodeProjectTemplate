...
final class SignInSignUpViewSnapshots: XCTestCase {
  
  // MARK: - Properties
  
  private var waitSeconds: TimeInterval!
  private var rootNavController: UINavigationController!
  private var sut: SignInSignUpViewController!
